...
public class Program {
	public static void main(String[] args) {
		...
		Map<String, Set<Person>> people1 = PeopleQuery.getPeopleGroupedByPositionInReverseOrder(
			allPeople
		);
		Map<String, Set<Person>> people2 = PeopleQuery.getPeopleGroupedByPositionInReverseOrder(
			List.of(person1, person2, person3, person4, person9, person10)
		);
		Map<String, Set<Person>> people3 = PeopleQuery.getPeopleGroupedByPositionInReverseOrder(
